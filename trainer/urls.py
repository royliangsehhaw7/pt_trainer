...
urlpatterns = [
    ...
    path('exercise/', exercise_view.exercise_list, name="exercise_list"),
    path('exercise/add/', exercise_view.exercise_add, name='exercise_add'),
    path("exercise/edit/<int:pk>/", exercise_view.exercise_edit, name="exercise_edit"),
    path("exercise/delete/<int:pk>/", exercise_view.exercise_delete, name="exercise_delete"),
